...
<div class="site-index">
    ...
    <div class="jumbotron text-center bg-transparent mt-5 mb-5">
        ...
        <p class="mt-4">
            ...
            <a class="btn btn-lg btn-outline-secondary ms-3" href="<?= Url::to('about') ?>">Узнать о SimpleMapp</a>
        </p>
    </div>
    ...
    <div class="body-content">
        ...
        <div class="row">
            <div class="col-lg-4 mb-3">
                ...
                <p><a class="btn btn-outline-secondary" href="<?= Url::to('under-development') ?>">Наша философия &raquo;</a></p>
            </div>
            <div class="col-lg-4 mb-3">
                ...
                <p><a class="btn btn-outline-secondary" href="<?= Url::to('products') ?>">Категории приложений &raquo;</a></p>
            </div>
            <div class="col-lg-4">
                ...
                <p><a class="btn btn-outline-secondary" href="<?= Url::to('contact') ?>">Поддержка и связь &raquo;</a></p>
            </div>
        </div>
        ...
        <div class="row text-center mt-5">
            <div class="col-lg-12">
                ...
                <p>
                    <a class="btn btn-success btn-lg" href="<?= Url::to('products') ?>">Перейти к приложениям</a>
                </p>
            </div>
        </div>
